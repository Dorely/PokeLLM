...
//    [Fact]
//    public async Task ContextGatheringPlugin_ShouldNotThrow400Error()
//    {
//        await TestSinglePlugin<ContextGatheringPlugin>("ContextGathering", 
//            "Please get game state information using available functions.");
//    }

//    [Fact]
//    public async Task ContextManagementPlugin_ShouldNotThrow400Error()
//    {
//        await TestSinglePlugin<ContextManagementPlugin>("ContextManagement", 
//            "Please search and verify entities using available functions.");
//    }

//    [Fact]
//    public async Task ChatManagementPlugin_ShouldNotThrow400Error()
//    {
//        await TestSinglePlugin<ChatManagementPlugin>("ChatManagement", 
//            "Please get adventure summary using available functions.");
//    }
...
//            kernel.Plugins.AddFromObject(_serviceProvider!.GetRequiredService<T>(), pluginName);
...
//    [Fact]
//    public async Task LLMProvider_Configuration_IsValid()
//    {
//        var config = _serviceProvider!.GetRequiredService<IOptions<FlexibleProviderConfig>>();
        
//        Assert.NotNull(config.Value);
//        Assert.NotNull(config.Value.LLM);
//        Assert.NotNull(config.Value.Embedding);
//        Assert.NotEmpty(config.Value.LLM.Provider);
//        Assert.NotEmpty(config.Value.Embedding.Provider);
        
//        Debug.WriteLine($"[LLMProvider_Configuration] LLM Provider: {config.Value.LLM.Provider}");
//        Debug.WriteLine($"[LLMProvider_Configuration] Embedding Provider: {config.Value.Embedding.Provider}");
//        Debug.WriteLine($"[LLMProvider_Configuration] LLM Model: {config.Value.LLM.ModelId}");
//        Debug.WriteLine($"[LLMProvider_Configuration] Embedding Model: {config.Value.Embedding.ModelId}");
//    }
//}