...
// Base classes for Ollama (768 dimensions)
public abstract class VectorRecordBase
{
    [VectorStoreKey]
    public Guid Id { get; set; }

    [VectorStoreVector(Dimensions: 768, DistanceFunction = DistanceFunction.CosineSimilarity, IndexKind = IndexKind.Hnsw)] // Ollama
    public string Embedding { get; set; } = string.Empty;
}

// Base classes for OpenAI (1536 dimensions)
public abstract class VectorRecordOpenAIBase
{
    [VectorStoreKey]
    public Guid Id { get; set; }

    [VectorStoreVector(Dimensions: 1536, DistanceFunction = DistanceFunction.CosineSimilarity, IndexKind = IndexKind.Hnsw)] // OpenAI
    public string Embedding { get; set; } = string.Empty;
}

#region Ollama-Compatible Models (768 dimensions)

/// <summary>
/// Represents a canonical record for an entity (Character, Pokemon Species, or Item)
/// in the vector store. (Ollama version - 768 dimensions)
/// </summary>
...
#region OpenAI-Compatible Models (1536 dimensions)

/// <summary>
/// Represents a canonical record for an entity (Character, Pokemon Species, or Item)
/// in the vector store. (OpenAI version - 1536 dimensions)
/// </summary>
public class EntityVectorRecordOpenAI : VectorRecordOpenAIBase
{
    [VectorStoreData(IsIndexed = true)]
    [Description("The unique, human-readable ID for the entity (e.g., 'char_prof_oak', 'species_pikachu'). Essential for direct lookups.")]
    public string EntityId { get; set; } = string.Empty;
...
/// in the vector store. (OpenAI version - 1536 dimensions)
/// </summary>
public class LocationVectorRecordOpenAI : VectorRecordOpenAIBase
{
    [VectorStoreData(IsIndexed = true)]
    [Description("The unique, human-readable ID for the location (e.g., 'loc_pallet_town').")]
    public string LocationId { get; set; } = string.Empty;
...
/// in the vector store. (OpenAI version - 1536 dimensions)
/// </summary>
public class LoreVectorRecordOpenAI : VectorRecordOpenAIBase
{
    [VectorStoreData(IsIndexed = true)]
    [Description("The unique, human-readable ID for the entry (e.g. 'quest_oaks_parcel', 'lore_legend_earth_sea').")]
    public string EntryId { get; set; } = string.Empty;
...
/// in the vector store. (OpenAI version - 1536 dimensions)
/// </summary>
public class GameRuleVectorRecordOpenAI : VectorRecordOpenAIBase
{
    [VectorStoreData(IsIndexed = true)]
    [Description("The unique, human-readable ID for the entry (e.g., 'rule_poison_effect', 'class_ace_trainer').")]
    public string EntryId { get; set; } = string.Empty;
...
/// in the vector store. (OpenAI version - 1536 dimensions)
/// </summary>
public class NarrativeLogVectorRecordOpenAI : VectorRecordOpenAIBase
{
    [VectorStoreData(IsIndexed = true)]
    [Description("The session ID this event belongs to. Critical for filtering memories by playthrough.")]
    public string SessionId { get; set; } = string.Empty;
